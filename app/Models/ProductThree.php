...
class ProductThree extends Model
{
    ...
    public static function boot()
    {
        ...
        static::created(function ($product) {
            ...
            $order = $product->mode == "demo" ? Order::where('product_type', 'THREE')->whereNull('breached_at')->whereNull('product_id')->first() : Order::where('product_type', 'THREE')->whereNull('breached_at')->whereNull('product_id')->where('phase', 3)->first();
